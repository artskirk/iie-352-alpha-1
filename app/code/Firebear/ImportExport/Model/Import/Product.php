    ...
    protected function _saveStockItem()
    {
        ...
        while ($bunch = $this->_dataSourceModel->getNextBunch()) {
            ...
            foreach ($bunch as $rowNum => $rowData) {
                ...
                if (isset($rowData['msi_source_code']) && !empty($rowData['msi_source_code'])) {
                ...
                try {
                    ...
                    if ($this->_parameters['configurable_create'] && !$this->isSkuExist($checkSku)) {
                        try {
                            ...
                            $updateData['eav_attributes'][ProductInterface::STATUS] = 1;
                            $updateData['eav_attributes']['visibility'] = Visibility::VISIBILITY_BOTH;
